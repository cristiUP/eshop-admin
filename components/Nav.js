...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-highlight text-gray-700 rounded-l-lg";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-600 p-4 pr-0 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"
      }
    >
